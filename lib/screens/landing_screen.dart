...
import 'package:fantasypl/screens/my_league.dart';
...
class LandingScreen extends ConsumerWidget {
  ...
  final List routes = [
    {"name": "Home", "route": const HomeScreen(), "icon": Icons.home_outlined},
    {
      "name": "Fixture",
      "route": const FixturesScreen(),
      "icon": Icons.list_alt
    },
    {"name": "MyLeague", "route": const MyLeagueScreen(), "icon": Icons.list}
  ];
      ...
      bottomNavigationBar: Container(
        ...
        decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
                colors: [dark.withOpacity(1), dark.withOpacity(1)],
        ...
        child: Row(
            ...
            children: List.generate(routes.length,
                (index) => buildItem(index, bottomNavData, ref))),
      ),
    );
  }
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: subtitleStyle.copyWith(
                          color: torquise, fontWeight: FontWeight.bold),
                    ),
                  ],
                ),
              )
