...
class _FixturesScreenState extends ConsumerState<MyLeagueScreen> {
  int currentGw = 0;
  int nowGw = 0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppbar(
        title: Text(
          "My League",
          style: titleStyle.copyWith(color: dark, fontWeight: FontWeight.bold),
        ),
        sufixWidget: Padding(
          ...
          child: Row(
            children: [
              TextButton(
                  onPressed: () {
                    ref
                        .read(currentGWProvider.notifier)
                        .getcurrentGw(nowGw - 1);
                    _carouselController.animateToPage(nowGw - 1);
                  },
                  child: Text(
                    "Current GW",
                    style: subtitleStyle.copyWith(color: dark),
                  )),
              bootstrapData.when(
        ...
        child: SingleChildScrollView(
          ...
          child: bootstrapData.when(
              data: (firstdata) {
                ...
                currentGw = currentGwData != 0
                    ? currentGwData
                    : firstdata.events!
                        .where((element) => element.isNext == true)
                        .map((e) => e.id)
                        .first!
                        .toInt();
                nowGw = firstdata.events!
                    .where((element) => element.isNext == true)
                    .map((e) => e.id)
                    .first!
                    .toInt();
                          ...
                          GestureDetector(
                            ...
                            child: Column(
                                children: List.generate(
                                    seconddata
                                        .where((element) =>
                                            element.event == currentGw)
                                        .length,
                                    (index) => _buildTeamContainer(
                                        firstdata,
                                        seconddata
                                            .where((element) =>
                                                element.event == currentGw)
                ...
                decoration: BoxDecoration(
                    ...
                    border: index + 1 == currentGw
                        ? const GradientBoxBorder(
                            gradient:
                                LinearGradient(colors: [torquise, primary]),
                            width: 1.6)
                        : Border.all(width: 0)),
                child: Text(
                  "Gameweek ${index + 1}",
  ...
  _buildTeamContainer(
      BootStrapModel firstdata, List<FixtureModel> seconddata, int index) {
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        firstdata.teams!
                            .firstWhere((element) =>
                                element.id == seconddata[index].teamH)
                            .name
                            .toString(),
                      ...
                      Image.network(
                        "https://resources.premierleague.com/premierleague/badges/t${firstdata.teams!.firstWhere((element) => element.id == seconddata[index].teamH).code}.png",
                        loadingBuilder: (context, child, loadingProgress) =>
                            loadingProgress == null
                                ? child
                                : const TeamImageShimmerWidget(),
                ...
                Expanded(
                    ...
                    child: Container(
                        ...
                        decoration: BoxDecoration(
                            color: white.withOpacity(0.4),
                            borderRadius: BorderRadius.circular(20)),
                        child: seconddata[index].teamHScore == -1 &&
                                seconddata[index].teamAScore == -1
                            ? Text(
                                DateFormat.jm().format(
                                    seconddata[index].kickoffTime.toLocal()),
                                style: subtitleStyle.copyWith(
                            ...
                            : Text(
                                "${seconddata[index].teamHScore} - ${seconddata[index].teamAScore}",
                                style: subtitleStyle.copyWith(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 14,
                                ),
                ...
                Expanded(
                  ...
                  child: Row(
                    children: [
                      ...
                      Image.network(
                        "https://resources.premierleague.com/premierleague/badges/t${firstdata.teams!.firstWhere((element) => element.id == seconddata[index].teamA).code}.png",
                        loadingBuilder: (context, child, loadingProgress) =>
                            loadingProgress == null
                                ? child
                                : const TeamImageShimmerWidget(),
                      ...
                      Text(
                        firstdata.teams!
                            .firstWhere((element) =>
                                element.id == seconddata[index].teamA)
                            .name
                            .toString(),
                        style: subtitleStyle.copyWith(
                            fontWeight: FontWeight.bold, fontSize: 12),
  ...
  void showbottomsheet(
      BootStrapModel firstdata, List<FixtureModel> seconddata, index) {
                ...
                seconddata[index].stats.isNotEmpty
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, statsindex) => Column(
                          children: [
                            seconddata[index].stats[statsindex].a.isNotEmpty ||
                                    seconddata[index]
                                        .stats[statsindex]
                                        .h
                                        .isNotEmpty
                                        ...
                                        children: List.generate(
                                            seconddata[index]
                                                ...
                                                : seconddata[index]
                                                    ...
                                                    .length,
                                            (hindex) => Text(
                                                  "${firstdata.elements!.firstWhere((element) => element.id == seconddata[index].stats[statsindex].h[hindex].element).webName}${seconddata[index].stats[statsindex].h[hindex].value == 1 ? "" : "(${seconddata[index].stats[statsindex].h[hindex].value.toString()})"}",
                                                  style: subtitleStyle,
                                                )))),
                                Expanded(
                                    flex: 1,
                                        ...
                                        children: List.generate(
                                            seconddata[index]
                                                ...
                                                : seconddata[index]
                                                    ...
                                                    .length,
                                            (aindex) => Text(
                                                  "${firstdata.elements!.firstWhere((element) => element.id == seconddata[index].stats[statsindex].a[aindex].element).webName}${seconddata[index].stats[statsindex].a[aindex].value == 1 ? "" : "(${seconddata[index].stats[statsindex].a[aindex].value})"}",
                                                  style: subtitleStyle,
                                                )))),
                              ],
                            )
